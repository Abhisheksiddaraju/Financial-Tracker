...
### Fixed
- Dashboard Expenses target now includes ETF Investment in total monthly budget
- Net Cash Flow calculation changed to Income − Actual Expenses (no double ETF subtraction)

### Improved
- Charts update immediately after budget changes
